<template>
    <div>
        ...
        <section class="top-title">
            <img :src="`../public/images/post/${form.avatar}`" alt="" style="width: 100vw; height: 500px; filter: brightness(30%)" />
            <div class="top-page">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="top-page-heading">
                                <h1>Du lịch tại {{ form.place_name }}</h1>
...
export default {
    ...
    methods: {
        ...
        show(page_url) {
            page_url = `../../../api/customer/post/detail/${this.post_slug}`
            fetch(page_url)
                .then((res) => res.json())
                .then((res) => {
